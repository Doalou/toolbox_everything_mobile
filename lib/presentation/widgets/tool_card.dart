...
class _ToolCardState extends State<ToolCard> {
  ...
  Widget build(BuildContext context) {
    ...
    final bool lowResourceMode =
        context.select<SettingsProvider, bool>((s) => s.lowResourceMode);
    ...
    final cardColor =
        AppConstants.expressiveColors.getColorByText(widget.tool.title);
  ...
  void _navigateToTool(BuildContext context) {
    final bool lowResourceMode = context.read<SettingsProvider>().lowResourceMode;
